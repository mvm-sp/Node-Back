...
const params = require('../parameters/doctorext');
...
function searchResults(req, res, result) {
  ...
  //Requerid idClient Field
  const idclient = queryParams.idclient
  ...
  //Filter by required idClient field
  let colResult = Object.values(result).filter(objResult => objResult.idclient == idclient);
